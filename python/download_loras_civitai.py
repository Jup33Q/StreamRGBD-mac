...
LORA_REGISTRY = {
    ...
    "civitai-epi-noiseoffset": {
        "model_id": 13941,
        "version_id": 16576,
        "display_name": "Epi Noise Offset 戏剧性光照",
        "filename": "epi_noiseoffset2.safetensors",
        "description": "深黑色与鲜艳高光的戏剧性光照效果。",
        "weight_min": 0.5,
        "weight_max": 1.0,
        "weight_default": 0.75,
        "trigger_words": "",
    ...
    "civitai-mecha-musume": {
        "model_id": 15464,
        "version_id": 18301,
        "display_name": "Mecha Musume 机娘",
        "filename": "AMechaSSS[color_theme,mecha musume, mechanical parts,robot joints,headgear].safetensors",
        "description": "机械少女/机娘风格，机甲与少女结合。",
        "weight_min": 0.5,
        "weight_max": 1.0,
        "weight_default": 0.75,
    ...
    "civitai-victorian-dress": {
        "model_id": 206700,
        "version_id": 232891,
        "display_name": "Victorian Dress 维多利亚礼服",
        "filename": "EleganceVic.safetensors",
        "description": "维多利亚时代华丽礼服，蕾丝与束腰。",
        "weight_min": 0.5,
        "weight_max": 1.0,
        "weight_default": 0.75,
    ...
    "civitai-instant-photo": {
        ...
        "filename": "InstantPhotoX3.safetensors",
...
def list_available():
    ...
    char_names = {
        "civitai-hanfu", "civitai-clothing-adjuster", "civitai-mecha-musume",
        "civitai-moesode", "civitai-victorian-dress", "civitai-instant-photo",
    }
