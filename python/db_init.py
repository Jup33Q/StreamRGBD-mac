...
# ── DepthModel 种子数据 ──
# Depth Anything V3 / V2 全系变体，默认优先 CoreML，自动回退 PyTorch。
DEPTH_MODEL_SEEDS = [
    {
        "name": "da3-small",
        "display_name": "Depth Anything V3 Small",
        "file_path": "coreml_models/da3_small.mlpackage",
        "description": "DA3 轻量模型，速度最快，适合实时预览。",
        "parameters": json.dumps({
    ...
    },
    {
        ...
        "file_path": "coreml_models/da3_base.mlpackage",
        "description": "DA3 Base 模型，速度与精度的平衡。",
        "parameters": json.dumps({
    ...
    },
    {
        ...
        "file_path": "coreml_models/da3_large.mlpackage",
        "description": "DA3 Large 模型，精度更高，推理更慢。",
        "parameters": json.dumps({
    ...
    },
    {
        ...
        "file_path": "coreml_models/da2_small.mlpackage",
        "description": "DA2 轻量模型，HuggingFace transformers 格式，CoreML 可转换。",
        "parameters": json.dumps({
    ...
    },
    {
        ...
        "file_path": "coreml_models/da2_base.mlpackage",
        "description": "DA2 Base 模型，速度与精度的平衡。",
        "parameters": json.dumps({
    ...
    },
    {
        ...
        "file_path": "coreml_models/da2_large.mlpackage",
        "description": "DA2 Large 模型，精度更高，推理更慢。",
        "parameters": json.dumps({
