...
LORA_MODEL_SEEDS = [
    ...
    {
        "name": "civitai-epi-noiseoffset",
        "display_name": "Civitai Epi Noise Offset 戏剧性光照",
        "file_path": "loras/epi-noiseoffset.safetensors",
        "repo_id": None,
        "filename": None,
        "civitai_version_id": 16576,
        "description": "深黑色与鲜艳高光的戏剧性光照效果（Civitai 来源）。",
        "parameters": json.dumps({'lora_scale': 0.75}),
        "weight_min": 0.5,
        "weight_max": 1.0,
        "weight_default": 0.75,
    ...
    {
        "name": "civitai-mecha-musume",
        "display_name": "Civitai Mecha Musume 机娘",
        "file_path": "loras/mecha-musume.safetensors",
        "repo_id": None,
        "filename": None,
        "civitai_version_id": 18301,
        "description": "机械少女/机娘风格，机甲与少女结合（Civitai 来源）。",
        "parameters": json.dumps({'lora_scale': 0.75}),
        "weight_min": 0.5,
        "weight_max": 1.0,
        "weight_default": 0.75,
        "trigger_words": "mecha musume, mechanical parts, robot joints",
        "source_type": "civitai",
        "file_size_mb": 36.0,
        "is_default": False,
        "is_active": True
    ...
    {
        "name": "civitai-victorian-dress",
        "display_name": "Civitai Victorian Dress 维多利亚礼服",
        "file_path": "loras/victorian-dress.safetensors",
        "repo_id": None,
        "filename": None,
        "civitai_version_id": 232891,
        "description": "维多利亚时代华丽礼服，蕾丝与束腰（Civitai 来源）。",
        "parameters": json.dumps({'lora_scale': 0.75}),
        "weight_min": 0.5,
        "weight_max": 1.0,
        "weight_default": 0.75,
        "trigger_words": "victorian dress, elegance",
        "source_type": "civitai",
        "file_size_mb": 36.0,
        "is_default": False,
        "is_active": True
