#!/usr/bin/env python3
"""
Convert DA3-SMALL to CoreML .mlpackage (v3).
...
Usage:
    python scripts/convert_da3_coreml_v3.py
    python scripts/convert_da3_coreml_v3.py --output-dir ./coreml_models
"""
import os
import sys
import time
...
# Also hardcode max_position for 504x504 (36x36 grid + 1 for cls_token shift = 37)
...
def convert_da3_small(output_dir: str) -> str:
    ...
    print("=" * 60)
    print("CoreML DA3-SMALL Conversion (v3)")
...
def main():
    parser = argparse.ArgumentParser(description="Convert DA3-Small to CoreML (v3)")
    parser.add_argument(
        "--output-dir",
